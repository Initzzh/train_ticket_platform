...
package org.opengoofy.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(org.opengoofy.framework.starter.log.annotation.ILog) || @annotation(org.opengoofy.framework.starter.log.annotation.ILog)")
