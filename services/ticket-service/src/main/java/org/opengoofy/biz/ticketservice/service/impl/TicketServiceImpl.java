...
package org.opengoofy.biz.ticketservice.service.impl;
...
import org.opengoofy.biz.ticketservice.common.enums.*;
import org.opengoofy.biz.ticketservice.dao.entity.*;
import org.opengoofy.biz.ticketservice.dao.mapper.*;
import org.opengoofy.biz.ticketservice.dto.domain.PurchaseTicketPassengerDetailDTO;
import org.opengoofy.biz.ticketservice.dto.domain.RouteDTO;
import org.opengoofy.biz.ticketservice.dto.domain.SeatClassDTO;
import org.opengoofy.biz.ticketservice.dto.domain.TicketListDTO;
import org.opengoofy.biz.ticketservice.dto.req.*;
import org.opengoofy.biz.ticketservice.dto.resp.RefundTicketRespDTO;
import org.opengoofy.biz.ticketservice.dto.resp.TicketOrderDetailRespDTO;
import org.opengoofy.biz.ticketservice.dto.resp.TicketPageQueryRespDTO;
import org.opengoofy.biz.ticketservice.dto.resp.TicketPurchaseRespDTO;
import org.opengoofy.biz.ticketservice.remote.PayRemoteService;
import org.opengoofy.biz.ticketservice.remote.TicketOrderRemoteService;
import org.opengoofy.biz.ticketservice.remote.dto.*;
import org.opengoofy.biz.ticketservice.service.SeatService;
import org.opengoofy.biz.ticketservice.service.TicketService;
import org.opengoofy.biz.ticketservice.service.TrainStationService;
import org.opengoofy.biz.ticketservice.service.cache.SeatMarginCacheLoader;
import org.opengoofy.biz.ticketservice.service.handler.ticket.dto.TrainPurchaseTicketRespDTO;
import org.opengoofy.biz.ticketservice.service.handler.ticket.select.TrainSeatTypeSelector;
import org.opengoofy.biz.ticketservice.service.handler.ticket.tokenbucket.TicketAvailabilityTokenBucket;
import org.opengoofy.biz.ticketservice.toolkit.DateUtil;
import org.opengoofy.biz.ticketservice.toolkit.TimeStringComparator;
import org.opengoofy.framework.starter.bases.ApplicationContextHolder;
import org.opengoofy.framework.starter.cache.DistributedCache;
import org.opengoofy.framework.starter.cache.toolkit.CacheUtil;
import org.opengoofy.framework.starter.common.toolkit.BeanUtil;
import org.opengoofy.framework.starter.convention.exception.ServiceException;
import org.opengoofy.framework.starter.convention.result.Result;
import org.opengoofy.framework.starter.designpattern.chain.AbstractChainContext;
import org.opengoofy.frameworks.starter.user.core.UserContext;
...
public class TicketServiceImpl extends ServiceImpl<TicketMapper, TicketDO> implements TicketService, CommandLineRunner {
    ...
    public TicketPageQueryRespDTO pageListTicketQueryV1(TicketPageQueryReqDTO requestParam) {
        ...
        if (count > 0) { //分布式锁解决缓存击穿问题， 使用双重判定锁，规避数据库无效
    ...
    public void cancelTicketOrder(CancelTicketOrderReqDTO requestParam) {
        ...
        if (cancelOrderResult.isSuccess() && !StrUtil.equals(ticketAvailabilityCacheUpdateType, "binlog")) {
            Result<org.opengoofy.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> ticketOrderDetailResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
            org.opengoofy.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetail = ticketOrderDetailResult.getData();
    ...
    public RefundTicketRespDTO commonTicketRefund(RefundTicketReqDTO requestParam) {
        ...
        Result<org.opengoofy.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> orderDetailRespDTOResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
        if (!orderDetailRespDTOResult.isSuccess() && Objects.isNull(orderDetailRespDTOResult.getData())) {
            throw new ServiceException("车票订单不存在");
        }
        org.opengoofy.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetailRespDTO = orderDetailRespDTOResult.getData();
